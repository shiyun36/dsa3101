...
def extract_url_to_esg_rag_database(url, country, industry):
    ...
    batches_text = batch_data_prepare_esg_text(esg_text_df)
    insert_esg_text_batch(batches_text)
    ...
    batches_rag = batch_data_prepare_esg_rag_table(esg_rag_df)
    insert_esg_rag_table_batch(batches_rag)
